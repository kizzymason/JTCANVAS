...
- PiAPI Seedream Pro/Lite 的宽高比像素与官方 Seedream 档位相同（16:9 为 1424x800 / 2816x1584 / 5504x3040），不要使用 PiAPI 文档里 16:9 的 1312x736 / 2560x1440 或 Lite 的 2848x1600 单独表。PiAPI 请求仍只传 `aspect_ratio` 与 `1K`/`2K`/`3K` 标签；Lite 界面 4K 对应上游 3K 计费。已改名的渠道模型（如「Seedream 5 Pro 【A低价渠道】【推荐】」）由管理员配置，重启不得改写展示名、能力和价格。
