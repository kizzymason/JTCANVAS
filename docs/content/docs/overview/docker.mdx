...
The main application container only runs Next.js. Canvases, My Assets, generation history, and API keys are stored in the browser by default. No persistent data volume is required for this data.
