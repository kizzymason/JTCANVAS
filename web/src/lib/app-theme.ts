    ...
    return {
        ...
        components: {
            Layout: {
                ...
                headerColor: dark ? "#fafafa" : "#171717",
                bodyBg: dark ? "#0c0a09" : "#fafaf9",
                siderBg: dark ? "#1c1917" : "#ffffff",
                triggerBg: dark ? "#1c1917" : "#ffffff",
                triggerColor: dark ? "#fafafa" : "#171717",
            },
            Button: {
                primaryShadow: "none",
            },
            ...
            Alert: {
                colorInfoBg: color.primary,
                colorInfoBorder: color.primary,
            },
        },
    };
}
