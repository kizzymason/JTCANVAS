...
export default function AssetsPage() {
    ...
    const saveAsset = async () => {
        ...
        try {
            ...
            message.error(t("assets.saveFailed"));
        }
    };
    ...
    const readImageFile = async (file?: File) => {
        ...
        const draft = { content: "", url: image.url, dataUrl: image.url, storageKey: image.storageKey, width: image.width, height: image.height, bytes: image.bytes, mimeType: image.mimeType };
        setImageDraft(draft);
