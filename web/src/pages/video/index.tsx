...
export default function VideoPage() {
    ...
    const deleteSelectedLogs = () => {
        // Only the local workbench log is removed; the server owns the authoritative record and files.
    ...
    return (
        <>
            ...
            <div className="col-span-2">
                <VideoSettingsPanel config={config} onConfigChange={(key, value) => updateConfig(key, value)} theme={theme} showTitle={false} className="space-y-4" modelValue={model} />
            </div>
        </>
    );
}
