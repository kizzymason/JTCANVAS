...
export function CanvasToolbar({
    ...
    return (
        <div ref={rootRef} className="pointer-events-none absolute bottom-4 left-3 right-3 z-50 flex justify-center lg:bottom-5 lg:left-[300px] lg:right-4">
            ...
            <div ref={wrapRef} className="thin-scrollbar pointer-events-auto flex h-14 max-w-full items-center gap-1 overflow-x-auto rounded-xl border px-2 shadow-lg backdrop-blur [&>*]:shrink-0" style={dockStyle}>
                ...
                {NODE_PLUGIN_UI_ENABLED && extensionDefs.length ? (
                    <ToolbarButton
                        id="tool-extensions"
            ...
            {NODE_PLUGIN_UI_ENABLED && extensionsOpen && extensionDefs.length ? (
                <div
