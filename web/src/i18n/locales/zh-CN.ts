export default {
    ...
    admin: {
        ...
        channels: {
            ...
            aspectPresets: "宽高比预设",
            aspectPresetsHint: "按模型独立配置，只出现在该模型的设置里。2K / 4K 留空时按 1K 的 2 倍 / 4 倍补齐，例如 16:9 的 1K 为 1280x720、2K 为 2560x1440。",
            ...
            aspectPreset1KRequired: "请填写 1K 像素，例如 1280x720",
            aspectPresetSizeInvalid: "像素格式为 1280x720",
            aspectPreset2KPlaceholder: "2× 自动",
            aspectPreset4KPlaceholder: "4× 自动",
