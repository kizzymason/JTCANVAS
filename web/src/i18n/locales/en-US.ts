export default {
    ...
    canvas: {
        ...
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", config: "Configuration node", configDescription: "Model, size, count, and input order", select: "Create node",
        },
        node: {
            node: "Node",
            untitled: "Untitled node", renameHint: "Double-click to rename the node", group: "Group", nodeCount: "{{count}} nodes", generating: "Generating", failed: "Generation failed", retry: "Retry", missingPlugin: "Plugin missing", missingPluginDescription: "The plugin for node type “{{type}}” is not installed or enabled", generateImage: "Generate image from text", generate: "Generate", editText: "Double-click to edit text", emptyImage: "Empty image node", emptyVideo: "Empty video node", emptyAudio: "Empty audio node", audio: "Audio", batchExpanded: "Image group expanded", batchCollapsed: "Image group collapsed", textBatchExpanded: "Text group expanded", textBatchCollapsed: "Text group collapsed", createCopy: "Create copy", setPrimary: "Set as primary", setPrimaryText: "Set as primary text",
        },
        sidePanel: {
        ...
        composer: { title: "Compose prompt", description: "Use @ to reference connected assets; references are renumbered before sending", placeholder: "Enter a prompt and use @ to reference connected images or text", imagePreview: "Referenced image preview", resources: { image: "Image {{index}}", video: "Video {{index}}", audio: "Audio {{index}}", text: "Text {{index}}", group: "Group {{index}}" } },
    ...
    auth: {
        subtitle: "Sign in to use the canvas, image and video studios",
        login: "Sign in",
        register: "Sign up",
        loginAction: "Sign in",
    ...
    admin: {
        ...
        overview: {
            title: "Dashboard",
            description: "Users, revenue, spend and generation activity",
            users: "Users",
            activeUsers: "{{count}} active",
            revenue: "Total topped up",
            spent: "Total spent",
        ...
        visitors: {
            title: "Visitors",
            description: "Frontend page views. Detail rows are kept for 30 days; daily totals are kept forever.",
            todayPv: "Today PV",
            todayUv: "Today UV",
            human: "Human",
            bot: "Bot",
